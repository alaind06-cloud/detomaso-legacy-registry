...
const fr = {
  ...
  "auth.reason": "Expliquez votre motivation (quel est votre lien avec {brand} ? Êtes-vous propriétaire, chercheur, passionné, etc. ?)",
  "auth.reason.placeholder": "Je suis propriétaire d'une {brand} depuis 2015 et je souhaite contribuer à l'historique de mon châssis…",
  "auth.reason.hint": "Minimum {min} caractères pour nous aider à comprendre votre demande.",
  "auth.reason.tooShort": "Votre motivation doit faire au moins {min} caractères. Donnez-nous un peu plus de contexte sur votre lien avec {brand}.",
...
const en: Dict = {
  ...
  "auth.phone": "Phone",
  "auth.reason": "Explain your motivation (what is your connection with {brand}? Are you an owner, researcher, enthusiast, etc.?)",
  "auth.reason.placeholder": "I have owned a {brand} since 2015 and would like to contribute to my chassis history…",
  "auth.reason.hint": "At least {min} characters to help us understand your request.",
  "auth.reason.tooShort": "Your motivation must be at least {min} characters long. Please give us more context about your connection with {brand}.",
  ...
  "founder.t1967": "In the mid-1960s, De Tomaso partnered with Carroll Shelby to develop a racing car, the P70. The collaboration was short-lived — Shelby delayed financing the project. De Tomaso then took over the chassis, combined it with bodywork designed by Giorgetto Giugiaro at Ghia, and turned the project into a road car: the Mangusta. The name was no accident: the mongoose is one of the few natural predators of the cobra — a direct nod to the Shelby Cobra, the fallen rival of the project.",
  "founder.t1971": "Unlike Enzo Ferrari, for whom the engine remained the sacred heart of the automobile, Alejandro de Tomaso took a pragmatic approach: integrate mass-produced, reliable and inexpensive Ford V8s, so he could focus his resources on chassis architecture and design. Legend has it that negotiations with Henry Ford II to distribute the Pantera in the United States through the Lincoln-Mercury network were struck informally, over a meal, before the legal documents were even signed.",
  "founder.t1975": "Acquisition of Maserati, then in serious financial difficulty following Citroën's withdrawal, through the Italian state-owned company GEPI. De Tomaso pursued a rapid development and accessible production strategy there, embodied by the Maserati Biturbo, which helped keep the brand active for more than a decade.",
...
const it: Dict = {
  ...
  "auth.password": "Password",
  "auth.phone": "Telefono",
  "auth.reason": "Spiega la tua motivazione (qual è il tuo legame con {brand}? Sei proprietario, ricercatore, appassionato, ecc.?)",
  "auth.reason.placeholder": "Sono proprietario di una {brand} dal 2015 e desidero contribuire alla storia del mio telaio…",
  "auth.reason.hint": "Almeno {min} caratteri per aiutarci a comprendere la tua richiesta.",
  "auth.reason.tooShort": "La tua motivazione deve contenere almeno {min} caratteri. Forniscici più contesto sul tuo legame con {brand}.",
  ...
  "founder.t1967": "A metà degli anni Sessanta, De Tomaso si allea con Carroll Shelby per sviluppare una vettura da corsa, la P70. La collaborazione dura poco: Shelby tarda a finanziare il progetto. De Tomaso riprende allora il telaio, lo abbina alla carrozzeria disegnata da Giorgetto Giugiaro per la Ghia, e trasforma il progetto in una vettura di serie: la Mangusta. Il nome non è casuale: la mangusta è uno dei pochi predatori naturali del cobra — un chiaro riferimento alla Shelby Cobra, rivale decaduta del progetto.",
  "founder.t1971": "A differenza di Enzo Ferrari, per cui il motore restava il cuore sacro dell'automobile, Alejandro de Tomaso adottava un approccio pragmatico: integrare V8 Ford di grande serie, affidabili ed economici, per concentrare le risorse sull'architettura del telaio e sul design. Si racconta che le trattative con Henry Ford II per la distribuzione della Pantera negli Stati Uniti attraverso la rete Lincoln-Mercury si siano intrecciate in modo informale, a tavola, prima ancora della firma dei documenti legali.",
  "founder.t1975": "Acquisizione della Maserati, allora in grave difficoltà finanziaria in seguito al ritiro della Citroën, attraverso la società pubblica italiana GEPI. De Tomaso vi avvia una strategia di sviluppo rapido e produzione accessibile, incarnata dalla Maserati Biturbo, che contribuirà a mantenere il marchio in attività per più di un decennio.",
